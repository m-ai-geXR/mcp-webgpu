...
const chatRelay = new ChatRelay(messageQueue, wsServer, {
  ...
  googleModel: process.env['GOOGLE_MODEL'] ?? 'gemini-3.1-pro-preview',
  mistralKey: process.env['MISTRAL_API_KEY'],
  mistralModel: process.env['MISTRAL_MODEL'] ?? 'mistral-large-latest',
  groqKey: process.env['GROQ_API_KEY'],
  groqModel: process.env['GROQ_MODEL'] ?? 'llama-3.3-70b-versatile',
  xaiKey: process.env['XAI_API_KEY'],
  xaiModel: process.env['XAI_MODEL'] ?? 'grok-4-0709',
  ...
  togetherModel: process.env['TOGETHER_MODEL'] ?? 'deepseek-ai/DeepSeek-R1-Distill-Llama-70B-free',
